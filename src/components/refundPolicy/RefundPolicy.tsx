        ...
        <div className="bg-gray-100 text-gray-800 min-h-screen">
            ...
            <main className="container mx-auto p-6">
                ...
                <section className="mb-8">
                    ...
                    <ul className="list-disc pl-5 mt-4 mb-4 text-lg leading-relaxed">
                ...
                <section>
                    ...
                    <ol type="1" className="list-disc pl-5 mt-4 mb-4 text-lg leading-relaxed">
                        <li>Contact our support at skills@knowledgebridgeint.com with your order details and evidence of the defect or issue</li>
