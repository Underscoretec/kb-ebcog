...
const ObjectiveSection = () => {
    ...
    return (
        <div className='bg-[#FFF4F8]'>
            <div className='text-[22px] xs:text-[42px] xl:text-[52px] pt-20 text-[#290849] font-[oswald] leading-[30px] xs:leading-[55px] w-[100%] lg:w-[87%] xl:w-[76%] xl:px-16 3xl:px-24 px-4 xs:px-8'>
