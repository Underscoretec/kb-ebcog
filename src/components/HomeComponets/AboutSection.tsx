...
const AboutSection = () => {
    return (
        <div className='lg:flex bg-[#FFF4F8]'>
            ...
            <div className='w-full lg:w-[51%] px-5 sm:px-10 lg:px-5 flex flex-col justify-center py-8 lg:py-8 xl:py-16'>
                <div id='ebcog'>
                    <div className='text-[22px] xs:text-[42px] sm:text-[42px] md:text-[42px] lg:text-[32px] xl:text-[42px] 2xl:text-[42px] font-oswald text-[#290849]'>About <span className='text-[#E4087F]'>EBCOG</span></div>
                    <div className='text-[22px] xs:text-[42px] sm:text-[42px] md:text-[42px] lg:text-[32px] xl:text-[42px] 2xl:text-[42px] pr-5 font-oswald text-[#290849]'>{`(European Board & College of Obstetrics and Gynaecology)`}</div>
                    <div className='text-[15px] sm:text-[15px] md:text-[20px] lg:text-[15px] xl:text-[18px] 2xl:text-[18px] font-oswald text-[#000000] leading-[25px] 2xl:leading-[32px] w-full lg:w-[98%] xl:w-[90%] 2xl:w-[90%]'>{`"EBCOG is the Board and College of the Section of Gynaecology and Obstetrics of the Union Européenne des Médecins
                ...
                <div id='knowledgeBridge'>
                    <div className='mt-3 lg:mt-3 xl:mt-4 2xl:mt-3 text-[22px] xs:text-[42px] sm:text-[42px] md:text-[42px] lg:text-[32px] xl:text-[42px] 2xl:text-[42px] font-oswald text-[#290849]'>About <span className='text-[#E4087F]'>KnowledgeBridge International</span></div>

                    <div className='mt-2 lg:mt-2 xl:mt-3 2xl:mt-3 text-[15px] sm:text-[15px] md:text-[20px] lg:text-[15px] xl:text-[18px] 2xl:text-[18px] font-oswald text-[#000000] leading-[25px] 2xl:leading-[32px] w-full lg:w-[98%] xl:w-[90%] 2xl:w-[90%]'>
                    ...
                    <div className='mt-3 lg:mt-3 xl:mt-4 2xl:mt-3 text-[15px] sm:text-[15px] md:text-[20px] lg:text-[15px] xl:text-[18px] 2xl:text-[18px] font-oswald text-[#000000] leading-[25px] 2xl:leading-[32px] w-full lg:w-[98%] xl:w-[90%] 2xl:w-[90%]'>
