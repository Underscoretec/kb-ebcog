    ...
    return (
        <div className='lg:flex bg-[#FFF4F8]'>
            ...
            <div className='w-full lg:w-[42%] px-5 sm:px-10 lg:px-5 flex flex-col justify-center py-8 lg:py-8 xl:py-16'>
                <div className='text-[35px] sm:text-[45px] md:text-[55px] lg:text-[35px] xl:text-[45px] 2xl:text-[55px] font-oswald text-[#290849]'>About <span className='text-[#E4087F]'>EBCOG</span></div>
                <div className='text-[35px] sm:text-[45px] md:text-[55px] lg:text-[35px] xl:text-[45px] 2xl:text-[55px] pr-5 font-oswald text-[#290849]'>{`(European Board & College of Obstetrics and Gynaecology)`}</div>
